  ...
  overrides: [
    {
      ...
      rules: {
        ...
        // Note: @typescript-eslint/ban-types was removed in v8. Using no-restricted-types instead is recommended
        // but we'll disable this check as it's handled by TypeScript itself
